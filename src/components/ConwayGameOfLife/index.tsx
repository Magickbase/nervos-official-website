...
export const ConwayGameOfLife = forwardRef<
  GameController,
  { initializationIndicatorRef: RefObject<HTMLElement>; defaultRunning?: boolean }
>(function ConwayGameOfLife(props, ref) {
  ...
  const [running, setRunning] = useState(props.defaultRunning ?? false)
  useInterval(
    () => {
      if (!running) return
